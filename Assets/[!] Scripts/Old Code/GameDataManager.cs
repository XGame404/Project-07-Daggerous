...
public static class GameDataManager
{
    ...
    {
        BinarySerializer.Save(playerData, "Daggerous-testingver4-data.txt");
    ...
    static void LoadPlayerData()
    {
        try
        {
            if (BinarySerializer.HasSaved("Daggerous-testingver4-data.txt"))
            {
                playerData = BinarySerializer.Load<PlayerData>("Daggerous-testingver4-data.txt");
